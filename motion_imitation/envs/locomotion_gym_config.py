...
from motion_imitation.envs.utilities.heightfield_randomizer import HeightfieldRandomizer
...
class SimulationParameters(object):
    ...
    heightfield_randomizer = attr.ib(type=bool, default=False)  # Flag to enable/disable terrain randomization
...
class LocomotionGymConfig(object):
    ...
    def setup_environment(self, env):
        """Sets up the environment with possible terrain randomization."""
        if self.simulation_parameters.heightfield_randomizer:
            randomizer = HeightfieldRandomizer()
